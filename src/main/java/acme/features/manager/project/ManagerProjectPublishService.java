...
public class ManagerProjectPublishService extends AbstractService<Manager, Project> {
	...
	public void bind(final Project object) {
		assert object != null;
		super.bind(object, "code", "title", "abstractt", "cost", "link", "indication");
	}

	@Override
	public void validate(final Project object) {
		assert object != null;
		final Collection<UserStory> userStories = this.repository.findUserStoriesByProject(object.getId());
		super.state(!userStories.isEmpty(), "*", "manager.project.form.error.nouserstory");
		if (!userStories.isEmpty()) {
			boolean publishedUserStories;
			publishedUserStories = userStories.stream().allMatch(x -> x.isDraftMode() == false);
			super.state(publishedUserStories, "*", "manager.project.form.error.userstorynp");
		}
	...
	public void unbind(final Project object) {
		assert object != null;
		Dataset dataset;
		dataset = super.unbind(object, "code", "title", "abstractt", "cost", "link", "draftMode", "manager", "indication");
